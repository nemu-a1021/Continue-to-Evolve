...
using static ContinuetoEvolve.Main;
...
namespace ContinuetoEvolve.Patches
{
    ...
    public class CustomOption
    {
        ...
        public CustomOption(int id, CustomOptionType type, string name, System.Object[] selections, System.Object defaultValue, CustomOption parent, bool isHeader)
        {
            ...
            if (id != 0)
            {
                entry = Instance.Config.Bind($"プリセット {preset}", id.ToString(), defaultSelection);
        ...
        public static void switchPreset(int newPreset)
        {
            ...
            foreach (CustomOption option in CustomOption.options)
            {
                ...
                option.entry = Instance.Config.Bind($"プリセット {preset}", option.id.ToString(), option.defaultSelection);
    ...
    class GameOptionsMenuStartPatch
    {
        public static void Postfix(GameOptionsMenu __instance)
        {
            ...
            if (killCoolOption != null) killCoolOption.ValidRange = new FloatRange(0f, 100f);
            ...
            NIMTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = LogoPatch.LoadSprite("NeutralInModes.Resources.NIMTabIcon.png", 100f);
            ...
            crewmateTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = LogoPatch.LoadSprite("NeutralInModes.Resources.NIMTabIconCrewmate.png", 100f);
            ...
            impostorTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = LogoPatch.LoadSprite("NeutralInModes.Resources.NIMTabIconImpostor.png", 100f);
            ...
            neutralTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = LogoPatch.LoadSprite("NeutralInModes.Resources.NIMTabIconNeutral.png", 100f);
            ...
            List<OptionBehaviour> NIMOptions = new();
            ...
            List<Transform> menus = new() { NIMMenu.transform, impostorMenu.transform, neutralMenu.transform, crewmateMenu.transform };
            List<List<OptionBehaviour>> optionBehaviours = new() { NIMOptions, impostorOptions, neutralOptions, crewmateOptions };
    ...
    class GameOptionsDataPatch
    {
        ...
        private static string buildOptionsOfType(CustomOption.CustomOptionType type, bool headerOnly)
        {
            ...
            foreach (CustomOption option in options)
            {
                if (option.parent != null)
                {
                    ...
                    sb.AppendLine(CustomOptionHolder.cs(c, $"{option.name}: {option.selections[option.selection].ToString()}"));
                }
                else
                {
        ...
        public static class GameOptionsNextPagePatch
        {
            public static void Postfix(KeyboardJoystick __instance)
            {
                ...
                {
                    if (optionsPage >= 5) optionsPage = 0;
                    else optionsPage++;
                }
            }
        }
